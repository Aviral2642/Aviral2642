...
- 🎓 **Penn State University (MS Cybersecurity)** — GPA: 4.0  
  Research Assistant | Red Team Teaching Assistant | RSA Security Scholar
...
- 🧠 **Speaker**: RSA Conference, HOPE XV, CypherCon, CactusCon  
- 🌍 **HackTheBox PRO HACKER**  
  Global Rank: Top 200 | 🇺🇸 USA Rank: #24  
  ![HTB Badge](https://www.hackthebox.com/badge/image/212766)

> 🔗 [View My Hack The Box Profile](https://app.hackthebox.com/profile/212766)
...
## 👽 Cyber-Themed Visual Widgets

- ⚡ [Glitch Terminal Portfolio](https://your-portfolio-link) *(Coming Soon)*  
- 🌐 [Live 3D Globe Attack Feed](https://github.com/Aviral2642/LiveGlobe)  
- 🛰️ AI-Powered Recon Parser + Payload Crafter  
- 🎛️ Custom Terminal UI for Real-Time Engagement Simulation
